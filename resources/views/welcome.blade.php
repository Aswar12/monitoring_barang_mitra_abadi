...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        @if (Route::has('login'))
            <h1 class="logo"><a href="index.html">MONITORING</a></h1>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active"
                style="background-image: url('assets-wel/img/slide/slide-1.jpg');">
            ...
            <div class="carousel-item"
                style="background-image: url('assets-wel/img/slide/slide-2.jpg');">
                <div class="carousel-container">
                    <div class="carousel-content">
            ...
            <!-- Slide 3 -->
            <div class="carousel-item"
                style="background-image: url('assets-wel/img/slide/slide-3.jpg')">
                <div class="carousel-container">
                    <div class="carousel-content">
